  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .lead-track {{
      ...
      align-items: center;
      width: max-content;
      animation: leadScroll 28s linear infinite;
    }}
    .lead-strip:hover .lead-track {{ animation-play-state: paused; }}
...
<body>
  ...
  <script>
    ...
    function renderLeadStrip() {{
      ...
      // Two identical sets of chips so the left-to-right scroll loops seamlessly
      // (the animation shifts the track by exactly one set, i.e. -50%).
